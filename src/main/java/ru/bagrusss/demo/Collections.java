...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            ...
            com.google.protobuf.MapEntry<java.lang.String, ru.bagrusss.demo.User>
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return ru.bagrusss.demo.CollectionsOuterClass.internal_static_demo_Collections_descriptor;
  }
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return ru.bagrusss.demo.CollectionsOuterClass.internal_static_demo_Collections_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            ru.bagrusss.demo.Collections.class, ru.bagrusss.demo.Collections.Builder.class);
  }
  ...
  private static final class UsersMapDefaultEntryHolder {
    static final com.google.protobuf.MapEntry<
        java.lang.String, ru.bagrusss.demo.User> defaultEntry =
            com.google.protobuf.MapEntry
            .<java.lang.String, ru.bagrusss.demo.User>newDefaultInstance(
                ru.bagrusss.demo.CollectionsOuterClass.internal_static_demo_Collections_UsersMapEntry_descriptor, 
  ...
  private com.google.protobuf.MapField<
      java.lang.String, ru.bagrusss.demo.User> usersMap_;
  private com.google.protobuf.MapField<java.lang.String, ru.bagrusss.demo.User>
  internalGetUsersMap() {
    if (usersMap_ == null) {
  ...
  public java.util.Map<java.lang.String, ru.bagrusss.demo.User> getUsersMap() {
  ...
  public java.util.Map<java.lang.String, ru.bagrusss.demo.User> getUsersMapMap() {
  ...
  public ru.bagrusss.demo.User getUsersMapOrDefault(
      java.lang.String key,
      ru.bagrusss.demo.User defaultValue) {
    if (key == null) { throw new java.lang.NullPointerException(); }
    java.util.Map<java.lang.String, ru.bagrusss.demo.User> map =
  ...
  public ru.bagrusss.demo.User getUsersMapOrThrow(
      java.lang.String key) {
    if (key == null) { throw new java.lang.NullPointerException(); }
    java.util.Map<java.lang.String, ru.bagrusss.demo.User> map =
        internalGetUsersMap().getMap();
  ...
  public final boolean isInitialized() {
    ...
    for (ru.bagrusss.demo.User item : getUsersMapMap().values()) {
  ...
  public int getSerializedSize() {
    ...
    for (java.util.Map.Entry<java.lang.String, ru.bagrusss.demo.User> entry
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof ru.bagrusss.demo.Collections)) {
      return super.equals(obj);
    }
    ru.bagrusss.demo.Collections other = (ru.bagrusss.demo.Collections) obj;
  ...
  public static ru.bagrusss.demo.Collections parseFrom(
  ...
  public static ru.bagrusss.demo.Collections parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static ru.bagrusss.demo.Collections parseFrom(
  ...
  public static ru.bagrusss.demo.Collections parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static ru.bagrusss.demo.Collections parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static ru.bagrusss.demo.Collections parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(ru.bagrusss.demo.Collections prototype) {
  ...
  public static final class Builder extends
      ...
      ru.bagrusss.demo.CollectionsOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ru.bagrusss.demo.CollectionsOuterClass.internal_static_demo_Collections_descriptor;
    }
    ...
    // Construct using ru.bagrusss.demo.Collections.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public ru.bagrusss.demo.Collections getDefaultInstanceForType() {
      return ru.bagrusss.demo.Collections.getDefaultInstance();
    }

    @java.lang.Override
    public ru.bagrusss.demo.Collections build() {
      ru.bagrusss.demo.Collections result = buildPartial();
    ...
    @java.lang.Override
    public ru.bagrusss.demo.Collections buildPartial() {
      ru.bagrusss.demo.Collections result = new ru.bagrusss.demo.Collections(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof ru.bagrusss.demo.Collections) {
        return mergeFrom((ru.bagrusss.demo.Collections)other);
      } else {
    ...
    public Builder mergeFrom(ru.bagrusss.demo.Collections other) {
      if (other == ru.bagrusss.demo.Collections.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      ru.bagrusss.demo.Collections parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (ru.bagrusss.demo.Collections) e.getUnfinishedMessage();
  ...
  ensureStringsIsMutable();
     ...
     */
    @java.lang.Deprecated
    public java.util.Map<java.lang.String, ru.bagrusss.demo.User>
    getMutableUsersMap() {
    ...
    public Builder putAllUsersMap(
        java.util.Map<java.lang.String, ru.bagrusss.demo.User> values) {
      internalGetMutableUsersMap().getMutableMap()
          .putAll(values);
      return this;
    }
  ...
  private static final ru.bagrusss.demo.Collections DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ru.bagrusss.demo.Collections();
  }

  public static ru.bagrusss.demo.Collections getDefaultInstance() {
