...
public interface CollectionsOrBuilder extends
  ...
  java.util.Map<java.lang.String, ru.bagrusss.demo.proto.User>
  getUsersMap();
  /**
   * <code>map&lt;string, .demo.User&gt; usersMap = 2;</code>
   */
  ...
  ru.bagrusss.demo.proto.User getUsersMapOrDefault(
      java.lang.String key,
  ...
  ru.bagrusss.demo.proto.User getUsersMapOrThrow(
      java.lang.String key);
}
